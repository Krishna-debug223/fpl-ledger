...
const gw4Report = JSON.parse(fs.readFileSync(path.join(root, 'data/gw4-report.json'), 'utf8'));
...
assert(gw4Report.gameweek === 4 && gw4Report.final === true, 'GW4 report must be final');
assert(gw4Report.activeCohort.count === 307, 'Unexpected GW4 active-cohort player count');
assert(gw4Report.activeCohort.mae === 2.124, 'Unexpected GW4 active-cohort MAE');
assert(gw4Report.activeCohort.within2 === 63.2, 'Unexpected GW4 +/-2 accuracy');
assert(gw4Report.snapshotHash === '67961131668128880769b6cd4f59d8716234bedfd56bb0fd01c195005f8fd13c', 'GW4 snapshot hash changed');
console.log('FPL Ledger GW3 portfolio data verified.');
console.log('FPL Ledger GW4 accuracy report verified.');
